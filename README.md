...
Official multilingual website for [Tech Echo Collective](https://techecho.org/).
...
Merging to the GitHub Pages publishing branch deploys the site. After deployment, the organization owner can add the site to Google Search Console and submit `https://techecho.org/sitemap.xml`; indexing remains controlled by Google.

### Google Search Console handoff

1. Add the URL-prefix property `https://techecho.org/` in Google Search Console.
...
4. Submit `https://techecho.org/sitemap.xml` in the Sitemaps report.
